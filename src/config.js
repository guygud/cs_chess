    ...
    defense: [
      {
        ...
        weight: 28,
        moves: [
          ['LONG', 'LONG', 'SHORT', 'BDOORS', 'MID'],
          ['LONG', 'LONG', 'SHORT', 'PLANTB', 'LOWTUNNEL'],
          ['LONG', 'LONG', 'SHORT', 'PLANTB', 'LOWTUNNEL'],
          ['LONG', 'LONG', 'SHORT', 'PLANTB', 'LOWTUNNEL'],
        ],
      },
      ...
      },
      {
        ...
        weight: 18,
        moves: [
          ['LONG', 'SHORT', 'BDOORS', 'BDOORS', 'MID'],
          ['LONG', 'SHORT', 'PLANTB', 'PLANTB', 'LOWTUNNEL'],
          ['LONG', 'SHORT', 'PLANTB', 'PLANTB', 'LOWTUNNEL'],
          ['LONG', 'SHORT', 'PLANTB', 'PLANTB', 'LOWTUNNEL'],
        ],
      },
      {
        ...
        weight: 12,
        moves: [
          ['LONG', 'LONG', 'LONG', 'SHORT', 'BDOORS'],
          ['LONG', 'LONG', 'LONG', 'SHORT', 'PLANTB'],
          ['LONG', 'LONG', 'LONG', 'SHORT', 'PLANTB'],
          ['LONG', 'LONG', 'LONG', 'SHORT', 'PLANTB'],
        ],
      },
      {
        ...
        weight: 12,
        moves: [
          ['SHORT', 'SHORT', 'SHORT', 'LONG', 'BDOORS'],
          ['SHORT', 'SHORT', 'SHORT', 'LONG', 'PLANTB'],
          ['SHORT', 'SHORT', 'SHORT', 'LONG', 'PLANTB'],
          ['SHORT', 'SHORT', 'SHORT', 'LONG', 'PLANTB'],
        ],
      },
      {
        ...
        weight: 10,
        moves: [
          ['MID', 'MID', 'BDOORS', 'LONG', 'SHORT'],
          ['LOWTUNNEL', 'LOWTUNNEL', 'PLANTB', 'LONG', 'SHORT'],
          ['LOWTUNNEL', 'LOWTUNNEL', 'PLANTB', 'LONG', 'SHORT'],
          ['LOWTUNNEL', 'LOWTUNNEL', 'PLANTB', 'LONG', 'SHORT'],
        ],
      },
